<template>
    <div id="">
      ...
      <div class="search-city" id="search-city">
        <input type="text" placeholder="请输入要搜索的城市" v-model="citySearch" :value="citySearch">
      </div>
      <div>
  ...
  export default {
    ...
    methods: {
      buildLetter: function () {  // 构建字母项
        ...
        for (let i = 0; i < 26; i++) {
          let obj = {}
          obj.letter = String.fromCharCode((65 + i)) // unicode A-Z 65-90
          obj.citylist = []
          letter.push(obj)
        }
      },
      ...
      positionInput: function () {
        var obj = document.getElementById('search-city')
        // var top = this.getTop(obj)
        var top = 0
